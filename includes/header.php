        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3 logo">
                    <a href="home"><img style="min-height: 60px; object-fit: cover;" src="image/cp2.png" alt=""></a>
                </div>
                <div class="col-md-9 col-sm-9 nav-wrapper">
                    ...
                    <nav>
                            ...
                            <div style="float: right;" id="menu1">
                                <ul class="sf-menu">
                                    <li><a href="login" style="border: 2px solid #b70c0c; color: #b70c0c;">Se connecter</a></li>
                                </ul>
                            </div>
