...
<!-- jQuery 3 -->
<script src="../superadmin/bower_components/jquery/dist/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="../superadmin/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<script src="../superadmin/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="../superadmin/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- FastClick -->
...
<script src="../superadmin/ad.js"></script>


<script src="../superadmin/dist/select2/js/select2.min.js"></script>
<script>
  $(function () {
    $('#example1').DataTable()
    $('#example2').DataTable({
