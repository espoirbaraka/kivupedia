...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Facture de paiement</li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        <section class="invoice">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <h2 class="page-header">
                                        <i class="fa fa-globe"></i> Pharmavie
                            ...
                            <div class="row no-print">
                                <div class="col-xs-12">
                                    <a href="print_facture.php?vente=<?php echo $vente; ?>" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Imprimer</a>
