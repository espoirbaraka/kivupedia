            ...
            <div class="modal-body">
                <form action="manager/create.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" name="event" value="CREATE_OPTION" required>
                        <label for="option" class="col-sm-3 control-label">Designation</label>
                        <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="manager/update.php">
                    <input type="hidden" class="option" name="id">
                    <input type="hidden" name="event" value="UPDATE_OPTION">
                    <div class="form-group">
                        <label for="edit_option" class="col-sm-3 control-label">Designation</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="edit_option" name="option" required>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="manager/delete.php">
                    <input type="hidden" class="option" name="id">
                    <input type="hidden" name="event" value="DELETE_OPTION">
                    <div class="text-center">
                        <p>SUPPRIMER L'OPTION</p>
